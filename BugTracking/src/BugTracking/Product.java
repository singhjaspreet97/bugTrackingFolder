...
public class Product extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            {
                String insert = "insert into products values('"+PRODUCTID+"','"+PRODUCT_NAME+"','"+VERSION+"')";
            ...
            {
                String str = "update products set PRODUCT_NAME='"+PRODUCT_NAME+"',VERSION='"+VERSION+"' where PRODUCTID='"+PRODUCTID+"'";
